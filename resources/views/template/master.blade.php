...
<head>
  ...
  <link rel="stylesheet" href="text/css" href="js/select.dataTables.min.css">
  @yield('css-content')
  {{-- TinyMCE --}}
...
<body>
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="{{ asset('skydash') }}/images/scarwashlogo.png" class="mr-2" alt="logo"/></a>
      </div>
  ...
  <script scr="{{ asset('skydash')}}/js/select2.js"></script>
